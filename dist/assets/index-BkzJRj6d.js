 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yS=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),we=(t,e)=>{const n=Z.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:l="",children:u,...c},f)=>Z.createElement("svg",{ref:f,...gS,width:i,height:i,stroke:r,strokeWidth:o?Number(s)*24/Number(i):s,className:["lucide",`lucide-${yS(t)}`,l].join(" "),...c},[...e.map(([m,y])=>Z.createElement(m,y)),...Array.isArray(u)?u:[u]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vS=we("AlertCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mf=we("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _S=we("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wS=we("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ES=we("Crown",[["path",{d:"m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14",key:"zkxr6b"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vg=we("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TS=we("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const IS=we("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const SS=we("Heart",[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xS=we("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g0=we("Loader2",[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const AS=we("Lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _g=we("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const RS=we("Mail",[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const CS=we("Menu",[["line",{x1:"4",x2:"20",y1:"12",y2:"12",key:"1e0a9i"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6",key:"1owob3"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18",key:"yk5zj1"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kS=we("RotateCcw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const PS=we("Ruler",[["path",{d:"M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.7 8.7a2.41 2.41 0 0 1 0-3.4l2.6-2.6a2.41 2.41 0 0 1 3.4 0Z",key:"icamh8"}],["path",{d:"m14.5 12.5 2-2",key:"inckbg"}],["path",{d:"m11.5 9.5 2-2",key:"fmmyf7"}],["path",{d:"m8.5 6.5 2-2",key:"vc6u1g"}],["path",{d:"m17.5 15.5 2-2",key:"wo5hmg"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const NS=we("Share2",[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bS=we("Star",[["polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",key:"8f66p6"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wg=we("Upload",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const DS=we("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const VS=we("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]);let Bh=null;const OS=t=>{Bh=t},U=t=>{const n=`[${new Date().toLocaleTimeString()}] ${t}`;console.log(n),Bh&&Bh(n)},LS=t=>new Promise((e,n)=>{U("🔄 Redimensionnement de l'image à 896x1152...");const r=document.createElement("canvas"),i=r.getContext("2d"),s=new Image;if(!i){n(new Error("Impossible de créer le contexte canvas"));return}s.onload=()=>{r.width=896,r.height=1152,i.fillStyle="#ffffff",i.fillRect(0,0,896,1152);const u=s.width/s.height,c=896/1152;let f,m;u>c?(m=1152,f=1152*u):(f=896,m=896/u);const y=(896-f)/2,T=(1152-m)/2;i.drawImage(s,y,T,f,m),r.toBlob(R=>{if(R){const P=new File([R],t.name,{type:"image/jpeg",lastModified:Date.now()});U(`✅ Image redimensionnée: ${P.size} bytes`),e(P)}else n(new Error("Impossible de créer le blob redimensionné"))},"image/jpeg",.9)},s.onerror=()=>{n(new Error("Impossible de charger l'image"))},s.src=URL.createObjectURL(t)}),MS=async(t,e)=>{U("🚀 Début du traitement d'image");try{if(U("🔍 Validation du fichier..."),!t||t.size===0)throw U("❌ Fichier invalide ou vide"),new Error("Fichier invalide ou vide");if(t.size>25*1024*1024)throw U(`❌ Fichier trop volumineux: ${t.size} bytes`),new Error("Fichier trop volumineux (max 25MB)");const n=(t.size/(1024*1024)).toFixed(2);if(U(`📏 Taille du fichier: ${t.size} bytes (${n} MB)`),!t.type.startsWith("image/"))throw U(`❌ Type de fichier invalide: ${t.type}`),new Error("Le fichier doit être une image");U(`✅ Fichier validé: ${t.name} (${t.size} bytes, ${t.type})`);let r;try{r=await LS(t)}catch(g){throw U(`❌ Erreur redimensionnement: ${g}`),new Error("Impossible de redimensionner l'image")}U("🔄 Début conversion base64...");let i;try{i=await jS(r);const g=(i.length*.75/1024).toFixed(2);U(`✅ Conversion réussie: ${i.length} caractères (~${g} KB)`)}catch(g){throw U(`❌ Erreur conversion: ${g}`),new Error("Impossible de traiter l'image")}if(!i||i.length===0)throw U("❌ Base64 vide après conversion"),new Error("Échec de la conversion de l'image");U(`🚀 Envoi vers webhook: ${e.gender} ${e.size.toUpperCase()}`),U("📦 Préparation du payload...");const s=e.mirror==="mirror"?"photo dans le miroir":"normal",o={image:i,gender:e.gender,size:e.size,mirror:s};U("📋 Paramètres ajoutés au payload:"),U(`  - gender: "${e.gender}"`),U(`  - size: "${e.size}"`),U(`  - mirror: "${s}"`);const l=JSON.stringify(o).length,u=(l/(1024*1024)).toFixed(2);if(U(`📦 Payload: ${l} caractères (${u} MB)`),l>100*1024*1024)throw U("❌ Payload trop volumineux pour l'envoi"),new Error("Image trop complexe à traiter. Essayez avec une image plus simple.");U(`📋 Paramètres: gender=${e.gender}, size=${e.size}, mirror=${e.mirror}`),U("🔍 Test de connectivité vers le serveur...");try{const g=await fetch("https://n8n-automatisation.fr/webhook-test/testvolt",{method:"OPTIONS",headers:{Accept:"*/*","Access-Control-Request-Method":"POST","Access-Control-Request-Headers":"Content-Type",Origin:window.location.origin}});U(`✅ Test CORS: ${g.status} ${g.statusText}`);const I={"Access-Control-Allow-Origin":g.headers.get("Access-Control-Allow-Origin"),"Access-Control-Allow-Methods":g.headers.get("Access-Control-Allow-Methods"),"Access-Control-Allow-Headers":g.headers.get("Access-Control-Allow-Headers")};U(`🔍 Headers CORS: ${JSON.stringify(I)}`)}catch(g){U(`⚠️ Test CORS échoué: ${g}`)}const c=["https://n8n-automatisation.fr/webhook-test/testvolt","https://n8n-automatisation.fr/webhook/testvolt"];let f;const m=1;let y,T=null;for(const g of c){U(`🌐 Test de l'URL: ${g}`);for(let I=0;I<=m;I++)try{U(`🔄 Tentative ${I+1}/${m+1} pour ${g}`);const N=new AbortController,L=setTimeout(()=>{U("⏰ Timeout - annulation de la requête"),N.abort()},15e3);U(`📡 Envoi de la requête... (${u} MB)`);const E=Date.now(),_={"Content-Type":"application/json"};U(`📋 Headers envoyés: ${JSON.stringify(_)}`),f=await fetch(g,{method:"POST",headers:_,body:JSON.stringify(o),signal:N.signal}),clearTimeout(L);const A=Date.now()-E;U(`✅ Requête envoyée en ${A}ms`),U(`📡 Statut reçu: ${f.status} ${f.statusText}`);const k={};f.headers.forEach((b,x)=>{k[x]=b}),U(`📋 Headers réponse: ${JSON.stringify(k)}`),T=g;break}catch(N){y=N,U(`❌ Tentative ${I+1} échouée pour ${g}: ${N instanceof Error?N.message:String(N)}`),N instanceof Error&&(U(`🔍 Type d'erreur: ${N.name}`),U(`🔍 Message: ${N.message}`),N.message.includes("Load failed")?U('🌐 Erreur "Load failed" - Essai avec proxy CORS...'):N.message.includes("NetworkError")?U("📡 Erreur réseau - Vérifiez votre connexion"):N.message.includes("CORS")?U("🚫 Erreur CORS - Tentative avec proxy..."):N.message.includes("Failed to fetch")&&U("📡 Failed to fetch - Tentative avec méthode alternative...")),I===m?U(`❌ Toutes les tentatives ont échoué pour ${g}`):(U("⏳ Attente de 2000ms avant retry..."),await new Promise(L=>setTimeout(L,2e3)))}if(f){U(`✅ Succès avec l'URL: ${T}`);break}}if(!f)return U("❌ Aucune réponse reçue - passage en mode simulation"),U("🎭 Activation du mode simulation automatique..."),await FS();if(U(`📡 Analyse de la réponse: ${f.status} ${f.statusText}`),!f.ok){const g=await f.text().catch(()=>"Erreur inconnue");throw U(`❌ Erreur serveur (${f.status}): ${g}`),new Error(`Erreur serveur (${f.status}): ${g}`)}const R=f.headers.get("content-type");U(`🎭 Type de contenu: ${R}`);const P=f.clone();try{const g=await P.text();if(U(`📝 Réponse reçue (${g.length} caractères)`),g.length===0)throw U("❌ Réponse vide du serveur"),new Error("Réponse vide du serveur");if(R!=null&&R.includes("application/json")){U("🔍 Parsing JSON...");const I=JSON.parse(g);if(U("📊 Données JSON reçues"),I.image||I.imageUrl||I.result){U("🖼️ Image trouvée dans la réponse");const N=I.image||I.imageUrl||I.result;if(typeof N=="string")return N.startsWith("http")?(U("✅ URL d'image reçue"),{success:!0,imageUrl:N}):N.startsWith("data:image/")?(U("✅ Image base64 avec préfixe reçue"),{success:!0,imageUrl:N}):(U("✅ Image base64 sans préfixe reçue"),{success:!0,imageUrl:`data:image/png;base64,${N}`})}return U("❌ Format de réponse JSON non reconnu"),{success:!1,error:"Format de réponse non reconnu"}}}catch(g){U(`⚠️ Impossible de lire comme texte: ${g}`)}U("🖼️ Traitement comme image binaire...");let C;try{C=await f.blob()}catch(g){throw U(`❌ Erreur lecture blob: ${g}`),new Error("Impossible de lire la réponse du serveur")}if(U(`📦 Blob reçu: ${C.size} bytes (${C.type})`),C.size===0)throw U("❌ Image reçue vide"),new Error("Image reçue vide");const w=URL.createObjectURL(C);return U("✅ URL de l'image créée"),U("🎯 Image reçue avec succès - Crédit sera déduit"),{success:!0,imageUrl:w}}catch(n){U(`❌ Erreur finale: ${n instanceof Error?n.message:n}`);let r="Erreur de traitement inconnue";return n instanceof Error&&(n.name==="AbortError"?r="Délai d'attente dépassé. Vérifiez votre connexion.":n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?r="Problème de connexion. Vérifiez votre réseau.":n.message.includes("Load failed")?r="Problème de connexion réseau. Vérifiez votre connexion internet.":n.message.includes("413")||n.message.includes("Request Entity Too Large")?r="Image trop volumineuse pour le serveur. Réduisez la taille de votre image.":r=n.message),U(`❌ Message final: ${r}`),{success:!1,error:r}}},jS=t=>new Promise((e,n)=>{if(U(`🔄 Conversion ${t.name}: ${t.size} bytes`),!t){U("❌ Aucun fichier fourni"),n(new Error("Aucun fichier fourni"));return}U(`📁 Type: ${t.type}, Taille: ${(t.size/1024).toFixed(1)} KB`);const r=new FileReader;r.onload=()=>{U("✅ FileReader onload");try{if(typeof r.result=="string"){const i=r.result.split(",")[1];if(!i||i.length===0){U("❌ Base64 vide après split"),n(new Error("Conversion base64 échouée"));return}U(`✅ Base64: ${i.length} chars`),e(i)}else U("❌ Résultat FileReader invalide"),n(new Error("Format de fichier non supporté"))}catch(i){U(`❌ Erreur dans onload: ${i}`),n(new Error("Erreur lors de la conversion"))}},r.onerror=()=>{U("❌ FileReader onerror"),n(new Error("Impossible de lire le fichier"))},r.onabort=()=>{U("❌ FileReader onabort"),n(new Error("Lecture du fichier interrompue"))};try{U("🚀 Lecture fichier..."),r.readAsDataURL(t)}catch(i){U(`❌ Erreur démarrage readAsDataURL: ${i}`),n(new Error("Impossible d'initier la lecture du fichier"))}}),FS=async()=>{U("🎭 Mode simulation - Création d'une image de démonstration..."),await new Promise(n=>setTimeout(n,1e3));const t=document.createElement("canvas");t.width=896,t.height=1152;const e=t.getContext("2d");if(e){const n=e.createLinearGradient(0,0,0,1152);return n.addColorStop(0,"#f8fafc"),n.addColorStop(1,"#e2e8f0"),e.fillStyle=n,e.fillRect(0,0,896,1152),e.fillStyle="#cbd5e1",e.beginPath(),e.ellipse(448,300,120,160,0,0,2*Math.PI),e.fill(),e.fillRect(368,460,160,400),e.fillRect(288,480,80,200),e.fillRect(528,480,80,200),e.fillRect(388,860,60,200),e.fillRect(448,860,60,200),e.fillStyle="#1e293b",e.font="bold 32px Arial",e.textAlign="center",e.fillText("SWEAR DEMO",448,100),e.font="24px Arial",e.fillStyle="#64748b",e.fillText("Mode Démonstration",448,140),e.fillText("Mannequin Virtuel",448,180),e.fillStyle="#09B1BA",e.font="bold 28px Arial",e.fillText("✨ Swear",448,1100),new Promise(r=>{t.toBlob(i=>{if(i){const s=URL.createObjectURL(i);U("✅ Image de démonstration créée avec succès"),r({success:!0,imageUrl:s})}else r({success:!1,error:"Impossible de créer l'image de démonstration"})},"image/png")})}return U("🎯 Image blob reçue avec succès - Crédit sera déduit"),{success:!1,error:"Impossible de créer le canvas de démonstration"}};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ox{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Lx(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Lx(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Wh="@firebase/app",Cg="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IA(t){fn(new Xt("platform-logger",e=>new Ox(e),"PRIVATE")),fn(new Xt("heartbeat",e=>new _A(e),"PRIVATE")),jt(Wh,Cg,t),jt(Wh,Cg,"esm2020"),jt("fire-js","")}IA("");var Dg=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,U0(t,r,n)}function U0(t,e,n){let r=`FIRESTORE (${cs}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(n!==void 0)try{r+=" CONTEXT: "+JSON.stringify(n)}catch{r+=" CONTEXT: "+n}throw On(r),new Error(r)}function ue(t,e,n,r){let i="Unexpected state";typeof n=="string"?i=n:r=n,t||U0(e,i,r)}function J(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fg=-62135596800,Ug=1e6;class ge{static now(){return ge.fromMillis(Date.now())}static fromDate(e){return ge.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),r=Math.floor((e-1e3*n)*Ug);return new ge(n,r)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new q(M.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new q(M.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<Fg)throw new q(M.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new q(M.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Ug}_compareTo(e){return this.seconds===e.seconds?re(this.nanoseconds,e.nanoseconds):re(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:ge._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Ho(e,ge._jsonSchema))return new ge(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-Fg;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}ge._jsonSchemaVersion="firestore/timestamp/1.0",ge._jsonSchema={type:be("string",ge._jsonSchemaVersion),seconds:be("number"),nanoseconds:be("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new q0("Invalid base64 string: "+s):s}}(e);return new Qe(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new Qe(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return re(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Qe.EMPTY_BYTE_STRING=new Qe("");const qA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function vr(t){if(ue(!!t,39018),typeof t=="string"){let e=0;const n=qA.exec(t);if(ue(!!n,46558,{timestamp:t}),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ce(t.seconds),nanos:Ce(t.nanos)}}function Ce(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function _r(t){return typeof t=="string"?Qe.fromBase64String(t):Qe.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cR=new xe(W.comparator);function Ln(){return cR}const lw=new xe(W.comparator);function Bs(...t){let e=lw;for(const n of t)e=e.insert(n.key,n);return e}function uw(t){let e=lw;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Ur(){return so()}function cw(){return so()}function so(){return new li(t=>t.toString(),(t,e)=>t.isEqual(e))}const hR=new xe(W.comparator),dR=new Me(W.comparator);function ie(...t){let e=dR;for(const n of t)e=e.add(n);return e}const fR=new Me(re);function pR(){return fR}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
