...
const PricingPage: React.FC<PricingPageProps> = ({ onBack, userEmail, currentUserEmail }) => {
  const { user } = useAuth();
  const emailToUse = userEmail || currentUserEmail || user?.email || '';

  const handleStripeRedirect = (planType: string, stripeUrl: string) => {
    if (emailToUse) {
      const urlWithEmail = stripeUrl.replace('exemple%40gmail.com', encodeURIComponent(emailToUse));
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                ...
                <ul className="list-disc list-inside mt-1">
                  ...
                  <li><strong>Date d'expiration :</strong> 12/34</li>
        ...
        <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0">
          ...
          <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-gray-500">Parfait pour commencer</p>
              <p className="mt-8">
            ...
            <div className="pt-6 pb-8 px-6">
              <h4 className="text-xs font-medium text-gray-900 tracking-wide uppercase">Inclus</h4>
              <ul className="mt-6 space-y-4">
                ...
                <li className="flex space-x-3">
                  ...
                  <span className="text-sm text-gray-500">Fonctionnalités de base</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border border-indigo-200 rounded-lg shadow-sm divide-y divide-gray-200 relative">
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-gray-500">Pour les utilisateurs réguliers</p>
              <p className="mt-8">
                <span className="text-4xl font-extrabold text-gray-900">9,90€</span>
                <span className="text-base font-medium text-gray-500">/mois</span>
              </p>
              <button
                onClick={() => handleStripeRedirect('starter', 'https://buy.stripe.com/test_fZucMYcHubsj23adLG2VG00?prefilled_email=exemple%40gmail.com')}
            ...
            <div className="pt-6 pb-8 px-6">
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li className="flex space-x-3">
                  ...
                  <span className="text-sm text-gray-500">Toutes les fonctionnalités</span>
                </li>
                <li className="flex space-x-3">
                  <svg className="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-gray-500">Pour les utilisateurs intensifs</p>
              <p className="mt-8">
                <span className="text-4xl font-extrabold text-gray-900">22,90€</span>
                <span className="text-base font-medium text-gray-500">/mois</span>
              </p>
              <button
                onClick={() => handleStripeRedirect('pro', 'https://buy.stripe.com/test_pro_link_here')}
